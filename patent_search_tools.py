...
def keyword_search(query_text, top_k=15):
    """
...
def semantic_search(query_text, top_k=15):
    """
...
def hybrid_search(query_text, top_k=15):
    """
...
def iterative_search(query_text, refinement_steps=3, top_k=15):
    """
